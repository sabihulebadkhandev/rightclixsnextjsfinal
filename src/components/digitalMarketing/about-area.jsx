...
const about_content = {
  ...
  des: (
    <>
      RightClixs is a software company that assists businesses and business
      owners in establishing their online presence across diverse digital
      platforms. Our aim is to help you accomplish your online business goals
...
const AboutArea = () => {
  return (
    <>
      <div className="tp-about-area pb-135 pt-135 blue-bg p-relative">
        <div className="tp-about-top-img-2">
          <Image src={img_1} alt="theme-pure" />
        </div>
        <div className="container">
