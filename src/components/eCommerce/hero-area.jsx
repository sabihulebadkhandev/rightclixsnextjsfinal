...
const hero_content = {
    ...
    title: <>
    <span><span className='child'>E-commerce web</span></span>{" "}
    <span><span className='child'>development Dubai</span></span>{" "}
    <span><span className='child'>turns visitors into</span></span>{" "}
    <span><span className='child'>loyal customers</span></span>
    </>,
                  ...
                  <div className="row">
                     <div className="col-xl-7 col-lg-7">
                        <div className="tp-hero-4-section-box pt-10 z-index-3">
                           ...
                           <h3 className="tp-hero-title-4 pb-35 tp-char-animation ecom">{title}</h3>
